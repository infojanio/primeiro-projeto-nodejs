...
export default class AlterProviderFieldToProviderId1594317082325 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.addColumn('appointments', new TableColumn({ //desfaz a alteraçao do campo provider
                name: 'provider',
                type: 'varchar',
            }),
        );
