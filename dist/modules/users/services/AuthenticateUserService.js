...
var AuthenticateUserService = /** @class */ (function () {
    function AuthenticateUserService(usersRepository, hasProvider) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Email ou senha incorreta!', 401);
                        }
                        return [4 /*yield*/, this.hasProvider.compareHash(password, user.password)];
                    case 2:
