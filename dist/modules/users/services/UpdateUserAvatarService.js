            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default('Só usuários autenticados podem mudar o avatar!', 401); // 401 serve p/ indicar que falta autenticação
                        }
                    ...
                    case 5:
                        _b.sent(); // atualiza o avatar, a função save serve tb para atualização
