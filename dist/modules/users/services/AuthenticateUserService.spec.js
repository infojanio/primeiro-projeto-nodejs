...
describe('AuthenticateUser', function () {
    beforeEach(function () {
        ...
        authenticateUser = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider); // salvamos na memória
    });
    ...
    it('should be able to authenticate with wrong password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
