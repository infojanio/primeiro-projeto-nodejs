...
var date_fns_1 = require("date-fns"); // retorna quantos dias tem no mês
var ListProviderDayAvailabilityService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        hourStart = 8;
                        eachHourArray = Array.from({ length: 10 }, // horários de 8 às 17h
                        function (_, index) { return index + hourStart; });
                        availability = eachHourArray.map(function (hour) {
                            ...
                            var currentDate = new Date(Date.now()); // data atual
                            var compareDate = new Date(year, month - 1, day, hour); // data de agora - 2020-09-17 08:00:00
                            return {
                                hour: hour,
    ...
    ListProviderDayAvailabilityService = __decorate([
        tsyringe_1.injectable() // disponibilidade de um prestador no mês
        ,
