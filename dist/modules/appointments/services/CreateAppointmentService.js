...
var CreateAppointmentService = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (findAppointmentInSameDate) {
                            // Tratativa de erros
                            throw new AppError_1.default('O horário já foi agendado!'); // o service não usa request e response,
                        }
    ...
    CreateAppointmentService = __decorate([
        tsyringe_1.injectable() // usamos em toda classe que recebe injeção de dependências
        ,
        __param(0, tsyringe_1.inject('IAppointmentsRepository')),
