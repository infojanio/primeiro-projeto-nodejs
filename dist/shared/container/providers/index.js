...
var HandlebarsMailTempateProvider_1 = __importDefault(require("./MailTemplateProvider/implementations/HandlebarsMailTempateProvider"));
tsyringe_1.container.registerSingleton('StorageProvider', DiskStorageProvider_1.default);
tsyringe_1.container.registerSingleton('MailTemplateProvider', HandlebarsMailTempateProvider_1.default);
